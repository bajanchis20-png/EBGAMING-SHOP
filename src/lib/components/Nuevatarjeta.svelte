...
>
    ...
    <div class="flex-1 p-8 space-y-4">
        <div>
            <h2
                class="text-4xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-yellow-500 to-yellow-600 uppercase tracking-widest mb-2"
            >
                {titulo}
            </h2>
            <p
