...
<section class="text-white p-8">
    ...
    <div class="grid grid-cols-2 gap-8">
        <Nuevatarjeta
            ...
            img="/setcaos.jpg"
            descripcion="El poder definitivo 60 media, para 215+.No pierdas la oportunidad de ser el top del servidor en PVM + GUÍA DE PVM"
        ></Nuevatarjeta>
        <Nuevatarjeta
            titulo="SET DE ENERGIA PERFECTO DOP "
            img="/setenergia.jpg"
            precio="35.00"
            descripcion="Domina el PVM y genera Won masivamente desde nivel 75 hasta 215 con este equipamiento optimizado + GUÍA DE PVM"
        ></Nuevatarjeta>
           <Nuevatarjeta
