...
<section class="text-white px-3 sm:px-6 py-10 sm:py-16 bg-[#0d0d0f] border-b border-white/10 relative overflow-x-hidden">
<div class="max-w-7xl mx-auto mb-8 px-2 sm:px-6 py-2">
    <h2 class="text-2xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-white mb-2">
        Vista del Catálogo
    </h2>
 
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-4">
        <div class="flex flex-col gap-3">
            <div class="flex items-center gap-3 text-neutral-400 uppercase tracking-[0.15em] text-[10px] sm:text-xs font-bold flex-wrap">
                <span>Metin2 Guabina</span>
                <span class="w-6 sm:w-8 h-[1px] bg-white/20"></span>
                <span>Equipamiento de Elite</span>
            </div>

           <div class="inline-flex items-center gap-2.5 px-4 py-2 rounded-2xl bg-[#121216] border border-white/10 hover:border-[#e60012]/50 text-white font-black tracking-[0.15em] uppercase shadow-[0_4px_20px_rgba(0,0,0,0.4)] transition-all duration-300 w-fit group cursor-default">
    <span class="flex h-2 w-2 relative">
      <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#e60012] opacity-75"></span>
      <span class="relative inline-flex rounded-full h-2 w-2 bg-[#e60012]"></span>
    </span>
    <span class="text-xs sm:text-sm text-neutral-200 group-hover:text-white transition-colors">
        ...
        <div class="w-full md:w-80">
            <div class="relative">
                <input 
                    ...
                    class="w-full bg-[#121216] border border-white/10 rounded-2xl px-4 py-3.5 text-sm text-white placeholder-neutral-500 focus:outline-none focus:border-[#e60012] focus:ring-1 focus:ring-[#e60012] transition-all font-bold shadow-sm"
                />
            </div>
        </div>
    </div>
...
<div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
  ...
  <button 
      ...
      class="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 z-50 bg-[#e60012] hover:bg-[#cc0010] text-white font-black p-3 sm:p-4 rounded-full shadow-[0_0_20px_rgba(230,0,18,0.5)] flex items-center justify-center transition-transform active:scale-95 cursor-pointer"
  ...
  <!-- Panel Deslizante del Carrito (Drawer) - 100% Responsive en Móviles -->
  {#if isCartOpen}
...
<!-- Sección FAQ (Estilo Gaming Oscuro, Profesional y Optimizado para Móviles) -->
<section class="py-12 sm:py-24 px-4 sm:px-6 bg-[#121216] border-t border-white/10 relative">
    <div class="max-w-3xl mx-auto">
        <div class="text-center mb-10 sm:mb-16">
            <h2 class="text-[#e60012] text-xs font-black uppercase tracking-[0.4em] mb-3">Resolución de Dudas</h2>
        ...
        <div class="space-y-4 sm:space-y-8">
            {#each [
                ...
                <div class="group relative bg-[#17171c] backdrop-blur-md border border-white/10 rounded-3xl p-5 sm:p-8 hover:border-[#e60012] transition-all duration-300 shadow-xl">
                    <h3 class="text-sm sm:text-xl font-black text-white uppercase tracking-wider mb-2 sm:mb-4 flex items-center gap-2 sm:gap-3">
                        <span class="text-[#e60012] text-lg sm:text-2xl font-black">/</span> {item.q}
                    </h3>
                    
                    <p class="text-neutral-400 text-xs sm:text-sm leading-relaxed font-bold pl-3 sm:pl-6 border-l-2 border-[#e60012] mb-4 sm:mb-6 uppercase">
                        {item.a}
                    </p>
